...
public class FriendRequestDatabase implements Repository<Tuple<Long, Long>, FriendshipRequest> {
    ...
    public FriendRequestDatabase(String tableName, Validator<FriendshipRequest> validator)
    {
